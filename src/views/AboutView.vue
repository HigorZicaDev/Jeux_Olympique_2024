    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32">
      ...
      <h1 class="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
          <span class="inline-block">Jeux 
              ...
              <span class="relative">Olympique</span></span>
          </span>
      ...
      <p class="mx-auto mt-9 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
          <span class="inline-block">L'objectif de ce projet est de partager des informations sur le tableau des médailles olympiques de manière rapide et efficace.</span>
      </p>
